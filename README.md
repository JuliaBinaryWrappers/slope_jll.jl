# `slope_jll.jl` (v2.6.0+0)

[![deps](https://juliahub.com/docs/slope_jll/deps.svg)](https://juliahub.com/ui/Packages/General/slope_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/5371be1a341b03e4248438b30920bd59ffc4dd56/S/slope/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/jolars/libslope.git (revision: `f489854a9a778ba5e8efaf566d3c6e8b9cdcca8b`)
